...
import toastsContainerTopRight from "./toastsContainerTopRight.vue"; // 引入上边定义好的 message 模板
const MessageBox = Vue.extend(toastsContainerTopRight); // 使用 Vue.extend 来创建一个构造器
