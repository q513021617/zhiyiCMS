        ...
        <div class="modal-body">
          ...
          <div v-if="isinputlist">
            <div v-for="item in infolist" v-bind:key="item.id">
              {{item.tag}}
              <input :name="item.name" v-model="item.value" />
            </div>
          </div>
            ...
            <div class="row">
              ...
              >
                ...
                >
                  ...
                  <button @click="selectimg(item.srcUrl)" class="blockstyle btn btn-danger show">
                    <i class="fas fa-search-plus"></i>选择
                  </button>
                </div>
              </div>
            </div>
