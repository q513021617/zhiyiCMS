      ...
      <section class="content">
        <div id="site_content-main" class="container-fluid">
          ...
          <input
            ...
            v-model="title"
            class="form-control"
            style="width: 30%;border-style: solid;border-width: medium;border-color: #007bff;"
          />
          ...
          <div class="row">
            <textarea
              ...
              v-model="description"
              class="form-control"
              style="width: 30%;height:auto; border-style:solid;border-width: medium;border-color: #007bff;"
            ></textarea>
          </div>
          <br />
          <div class="row">
