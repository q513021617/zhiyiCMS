...
import MessageModal from "./Message.vue"; // 引入上边定义好的 message 模板
const MessageBox = Vue.extend(MessageModal); // 使用 Vue.extend 来创建一个构造器
...
export default {
  message: Message,
  install(Vue) {
    Vue.prototype.$messageModal = Message;
    Vue.messageModal = Message;
  }
};